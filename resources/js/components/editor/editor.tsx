  ...
  'relative w-full cursor-text overflow-y-auto caret-primary select-text selection:bg-primary/25 focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-primary/25 [&_.slate-selection-area]:bg-primary/15',
  {
    ...
    variants: {
      variant: {
        ...
        demo: 'h-[650px]',
        select: cn(
          'group rounded-md border border-input ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-0',
  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default: 'size-full px-2 pt-4 pb-72 text-base',
