...
function DrawerTrigger({ ...props }: React.ComponentProps<typeof DrawerPrimitive.Trigger>) {
  return <DrawerPrimitive.Trigger data-slot="drawer-trigger" className="cursor-pointer" {...props} />
}
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          'px-4 py-2.5',
          'group/drawer-content fixed z-50 flex h-auto flex-col bg-gray-100',
